        ...
        if (this.state.isEditing) {
            return (
                <td>
                    ...
                    <button className="btn btn-dark" onClick={this.setEditState.bind(this, false)}>Cancel<i className="fa fa-ban" aria-hidden="true"></i></button>
                </td>
            );
        }
        return (
            <td>
                ...
                <button className="btn btn-dark" onClick={this.deleteTask.bind(this)}>Delete<i className="fa fa-trash" aria-hidden="true"></i></button>
            </td>
        );
    }
